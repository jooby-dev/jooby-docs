...
| ID       | Name                                                    | Description                                                                  |
| -------- | ------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `0x02`   | [SetTime2000](./SetTime2000.md#request)                 | Request to set device time when the difference is more than `127` seconds.   |
...
| `0x09`   | [GetTime2000](./GetTime2000.md#request)                 | Request to get the sensor current time.                                      |
| `0x0b`   | [GetArchiveEvents](./GetArchiveEvents.md#request)       | Request to get events from archive.                                          |
...
| `0x1a`   | [GetArchiveHoursMC](./GetArchiveHoursMC.md#request)     | Request to get hour values from archive.                                     |
| `0x1b`   | [GetArchiveDaysMC](./GetArchiveDaysMC.md#request)       | Request to get day values from archive.                                      |
| `0x1e`   | [DataSegment](./DataSegment.md#request)                 | Request to send a data segment.                                              |
| `0x1f02` | [GetLmicInfo](./GetLmicInfo.md#request)                 | Request to get LMiC (IBM LoRaWAN in C) information.                          |
| `0x1f05` | [GetBatteryStatus](./GetBatteryStatus.md#request)       | Request to get status information from the sensor battery.                   |
| `0x1f06` | [DepassivateBattery](./DepassivateBattery.md#request)   | Request to manually depassivate the device battery.                          |
| `0x1f07` | [USWaterMeterCommand](./USWaterMeterCommand.md#request) | Request to directly access the ultrasonic water meter.                       |
| `0x1f0c` | [GetExAbsArchiveHoursMC](./GetExAbsArchiveHoursMC.md#request) | Request hourly consumption (absolute values) from the archive.         |
| `0x1f0d` | [GetExAbsArchiveDaysMC](./GetExAbsArchiveDaysMC.md#request) | Request daily consumption (absolute values) from the archive.           |
...
| `0x1f30` | [GetArchiveHoursMCEx](./GetArchiveHoursMCEx.md#request) | Request hour archive values when more than 8 hours are needed.               |
...
| `0x1f34` | [GetSignalQuality](./GetSignalQuality.md#request)       | Request NB-IoT signal quality.                                               |
...
| `0x09`   | [GetTime2000](./GetTime2000.md#response)                           | Current device time.                                                                                                                              |
...
| `0x15`   | [NewEvent](./uplink/NewEvent.md)                                   | Device event information.                                                                                                                         |
| `0x16`   | [DayMC](./uplink/DayMC.md)                                         | Pulse counter data on billing hour.                                                                                                               |
| `0x17`   | [HourMC](./uplink/HourMC.md)                                       | Pulse counter data, accumulated on an hour basis.                                                                                                  |
...
| `0x1f05` | [GetBatteryStatus](./GetBatteryStatus.md#response)                 | Response to the [GetBatteryStatus](./GetBatteryStatus.md#request) downlink command.                                                               |
| `0x1f06` | [DepassivateBattery](./DepassivateBattery.md#response)             | Response to the [DepassivateBattery](./DepassivateBattery.md#request) downlink command.                                                           |
...
| `0x1f0c` | [GetExAbsArchiveHoursMC](./GetExAbsArchiveHoursMC.md#response)     | Response to the [GetExAbsArchiveHoursMC](./GetExAbsArchiveHoursMC.md#request) downlink command.                                                   |
| `0x1f0d` | [GetExAbsArchiveDaysMC](./GetExAbsArchiveDaysMC.md#response)       | Response to the [GetExAbsArchiveDaysMC](./GetExAbsArchiveDaysMC.md#request) downlink command.                                                     |
...
| `0x1f2a` | [WriteImage](./WriteImage.md#response)                             | Response to the [WriteImage](./WriteImage.md#request) downlink command.                                                                           |
| `0x1f2b` | [VerifyImage](./VerifyImage.md#response)                           | Response to the [VerifyImage](./VerifyImage.md#request) downlink command.                                                                         |
| `0x1f2c` | [UpdateRun](./UpdateRun.md#response)                               | Response to the [UpdateRun](./UpdateRun.md#request) downlink command.                                                                             |
...
| `0x60`   | [LastEvent](./uplink/LastEvent.md)                                 | Last event sequence number and status bits.                                                                                                       |
| `0x1f30` | [GetArchiveHoursMCEx](./GetArchiveHoursMCEx.md#response)           | Response to the [GetArchiveHoursMCEx](./GetArchiveHoursMCEx.md#request) downlink command.                                                         |
| `0x1f31` | [HourMCEx](./uplink/HourMCEx.md)                                   | Pulse counter data, accumulated on an hour basis. Limited by protocol packet max size up to 256 hours.                                             |
...
| `0x1f34` | [GetSignalQuality](./GetSignalQuality.md#response)                 | Response to the [GetSignalQuality](./GetSignalQuality.md#request) downlink command or an addition to each uplink if parameter `0x39` is enabled.  |
