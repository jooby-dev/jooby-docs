...
| accumulated data `2:00-2:30`           | tariff: `T2`,  accumulated data:`16` | `0x4010` |
| accumulated data `2:30-3:00`           | tariff: `T2`,  accumulated data:`18` | `0x4012` |
| accumulated data `3:00-3:30`           | tariff: `T4`,  accumulated data:`17` | `0xc011` |
