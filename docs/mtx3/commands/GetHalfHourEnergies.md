...
| `1`  | `uint8` | index of the first requested record (valid index range `0 – 48`) |
...
| index of the first requested record    | `5`                                 | `0x05`   |
...
| `1`   | `uint8`  | number of requested records                                              |
| `2*n` | `uint16` | accumulated data of all phases, according to [energy type](#energy-type) |

> `n` - the number of energies derived from packed energy type field.

An accumulated data value of `0xffff` indicates that no data is available because the meter was turned off.
...
| accumulated data `2:00-2:30`           | accumulated data:`16`               | `0x4010` |
| accumulated data `2:30-3:00`           | accumulated data:`18`               | `0x4012` |
| accumulated data `3:00-3:30`           | accumulated data:`17`               | `0xc011` |

Command hex dump: `6f 0b 2a43 01 04 03 4010 4012 c011`
