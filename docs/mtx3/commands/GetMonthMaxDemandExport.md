...
Request/response to get the maximum monthly power (`II`-`III` quadrant) for all tariffs (`T1`-`T4`).
...
| `1`    | `uint8`                                                 | year (number of years after `2000`)                          |
| `1`    | `uint8`                                                 | month (`1` - January ... `12` - December)                    |
| `18*n` | [tariffEnergy](./GetDayMaxDemandExport.md#tariffenergy) | field set with time and energies for each tariff (`T1`-`T4`) |
