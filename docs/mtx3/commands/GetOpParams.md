...
| Name                            | Bit  | Description                                                                                                                              |
| ------------------------------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `CURRENT_PHASE_A`               | `0`  | enable display of Phase A current. OBIS: `31.7.0`                                                                                        |
| `CURRENT_PHASE_B`               | `1`  | enable display of Phase B current. OBIS: `51.7.0`                                                                                        |
| `CURRENT_PHASE_C`               | `2`  | enable display of Phase C current. OBIS: `71.7.0`                                                                                        |
| `CURRENT_NEUTRAL`               | `3`  | enable display of neutral current. OBIS: `91.7.0`                                                                                        |
| `VOLTAGE_PHASE_A`               | `4`  | enable display of Phase A voltage. OBIS: `32.7.0`                                                                                        |
| `VOLTAGE_PHASE_B`               | `5`  | enable display of Phase B voltage. OBIS: `52.7.0`                                                                                        |
| `VOLTAGE_PHASE_C`               | `6`  | enable display of Phase C voltage. OBIS: `72.7.0`                                                                                        |
| `VOLTAGE_BATTERY`               | `7`  | enable display of battery voltage                                                                                                        |
| `SUPPLY_FREQUENCY`              | `8`  | enable display of supply frequency. OBIS: `14.7.0`                                                                                       |
| `TOTAL_ACTIVE_POWER`            | `9`  | enable display of total active power for all phases - `P`, OBIS: `1.7.0` (for meter type `R`), `P±`, OBIS: `16.7.0` (for meter type `G`) |
...
| `TOTAL_REACTIVE_POWER_QPLUS`    | `13` | enable display of total inductive reactive power for all phases `QI+QII`, OBIS: `3.7.0`                                                  |
...
| `TOTAL_REACTIVE_POWER_QMINUS`   | `17` | enable display of total capacitive reactive power for all phases `QIII+QIV`, OBIS: `4.7.0`                                               |
...
| `TOTAL_APPARENT_QPLUS_POWER`    | `25` | enable display of total positive apparent power for all phases, `QI+QIV`, OBIS: `9.7.0`                                                  |
...
| `TOTAL_APPARENT_POWER_QMINUS`   | `29` | enable display of total negative apparent power for all phases, `QII+QIII`, OBIS: `10.7.0`                                               |
...
| `MAX_DAILY_ACTIVE_POWER_T1`               | `1`  | enable display of maximum daily active power for tariff `T1` - `\|P\|`, OBIS: `15.26.1` (for meter type `R`); `P+`, OBIS: `1.26.1` (for meter type G`)    |
| `MAX_DAILY_ACTIVE_POWER_T2`               | `2`  | enable display of maximum daily active power for tariff `T2` - `\|P\|`, OBIS: `15.26.2` (for meter type `R`); `P+`, OBIS: `1.26.2` (for meter type G`)    |
| `MAX_DAILY_ACTIVE_POWER_T3`               | `3`  | enable display of maximum daily active power for tariff `T3` - `\|P\|`, OBIS: `15.26.3` (for meter type `R`); `P+`, OBIS: `1.26.3` (for meter type G`)    |
| `MAX_DAILY_ACTIVE_POWER_T4`               | `4`  | enable display of maximum daily active power for tariff `T4` - `\|P\|`, OBIS: `15.26.4` (for meter type `R`); `P+`, OBIS: `1.26.4` (for meter type G`)    |
| `MAX_MONTHLY_ACTIVE_POWER_T1`             | `5`  | enable display of maximum monthly active power for tariff `T1` - `\|P\|`, OBIS: `15.16.1` (for meter type `R`); `P+`, OBIS: `1.16.1` (for meter type `G`) |
| `MAX_MONTHLY_ACTIVE_POWER_T2`             | `6`  | enable display of maximum monthly active power for tariff `T2` - `\|P\|`, OBIS: `15.16.2` (for meter type `R`); `P+`, OBIS: `1.16.2` (for meter type `G`) |
| `MAX_MONTHLY_ACTIVE_POWER_T3`             | `7`  | enable display of maximum monthly active power for tariff `T3` - `\|P\|`, OBIS: `15.16.4` (for meter type `R`); `P+`, OBIS: `1.16.3` (for meter type `G`) |
| `MAX_MONTHLY_ACTIVE_POWER_T4`             | `8`  | enable display of maximum monthly active power for tariff `T4` - `\|P\|`, OBIS: `15.16.4` (for meter type `R`); `P+`, OBIS: `1.16.4` (for meter type `G`) |
| `MAX_DAILY_REACTIVE_POWER_T1`             | `9`  | enable display of maximum daily reactive power for tariff `T1` - `Q+`, OBIS: `3.26.1` (for meter type `R`); `QI`, OBIS: `5.26.1` (for meter type `G`)     |
| `MAX_DAILY_REACTIVE_POWER_T2`             | `10` | enable display of maximum daily reactive power for tariff `T2` - `Q+`, OBIS: `3.26.2` (for meter type `R`); `QI`, OBIS: `5.26.2` (for meter type `G`)     |
| `MAX_DAILY_REACTIVE_POWER_T3`             | `11` | enable display of maximum daily reactive power for tariff `T3` - `Q+`, OBIS: `3.26.3` (for meter type `R`); `QI`, OBIS: `5.26.3` (for meter type `G`)     |
| `MAX_DAILY_REACTIVE_POWER_T4`             | `12` | enable display of maximum daily reactive power for tariff `T4` - `Q+`, OBIS: `3.26.4` (for meter type `R`); `QI`, OBIS: `5.26.4` (for meter type `G`)     |
| `MAX_MONTHLY_REACTIVE_POWER_T1`           | `13` | enable display of maximum monthly reactive power for tariff `T1` - `Q+`, OBIS: `3.16.1` (for meter type `R`); `QI`, OBIS: `5.16.1` (for meter type `G`)   |
| `MAX_MONTHLY_REACTIVE_POWER_T2`           | `14` | enable display of maximum monthly reactive power for tariff `T2` - `Q+`, OBIS: `3.16.2` (for meter type `R`); `QI`, OBIS: `5.16.2` (for meter type `G`)   |
| `MAX_MONTHLY_REACTIVE_POWER_T3`           | `15` | enable display of maximum monthly reactive power for tariff `T3` - `Q+`, OBIS: `3.16.3` (for meter type `R`); `QI`, OBIS: `5.16.3` (for meter type `G`)   |
| `MAX_MONTHLY_REACTIVE_POWER_T4`           | `16` | enable display of maximum monthly reactive power for tariff `T4` - `Q+`, OBIS: `3.16.4` (for meter type `R`); `QI`, OBIS: `5.16.4` (for meter type `G`)   |
| `MAX_DAILY_NEGATIVE_REACTIVE_POWER_T1`    | `17` | enable display of maximum daily reactive power for tariff `T1` - `Q-`, OBIS: `4.26.1` (for meter type `R`); `QI`, OBIS: `8.26.1` (for meter type `G`)     |
| `MAX_DAILY_NEGATIVE_REACTIVE_POWER_T2`    | `18` | enable display of maximum daily reactive power for tariff `T2` - `Q-`, OBIS: `4.26.2` (for meter type `R`); `QI`, OBIS: `8.26.2` (for meter type `G`)     |
| `MAX_DAILY_NEGATIVE_REACTIVE_POWER_T3`    | `19` | enable display of maximum daily reactive power for tariff `T3` - `Q-`, OBIS: `4.26.3` (for meter type `R`); `QI`, OBIS: `8.26.3` (for meter type `G`)     |
| `MAX_DAILY_NEGATIVE_REACTIVE_POWER_T4`    | `20` | enable display of maximum daily reactive power for tariff `T4` - `Q-`, OBIS: `4.26.4` (for meter type `R`); `QI`, OBIS: `8.26.4` (for meter type `G`)     |
| `MAX_MONTHLY_NEGATIVE_REACTIVE_POWERS_T1` | `21` | enable display of maximum monthly reactive power for tariff `T1` - `Q+`, OBIS: `4.16.1` (for meter type `R`); `QI`, OBIS: `8.16.1` (for meter type `G`)   |
| `MAX_MONTHLY_NEGATIVE_REACTIVE_POWER_T2`  | `22` | enable display of maximum monthly reactive power for tariff `T2` - `Q+`, OBIS: `4.16.2` (for meter type `R`); `QI`, OBIS: `8.16.2` (for meter type `G`)   |
| `MAX_MONTHLY_NEGATIVE_REACTIVE_POWERS_T3` | `23` | enable display of maximum monthly reactive power for tariff `T3` - `Q+`, OBIS: `4.16.3` (for meter type `R`); `QI`, OBIS: `8.16.3` (for meter type `G`)   |
| `MAX_MONTHLY_NEGATIVE_REACTIVE_POWER_T4`  | `24` | enable display of maximum monthly reactive power for tariff `T4` - `Q+`, OBIS: `4.16.4` (for meter type `R`); `QI`, OBIS: `8.16.4` (for meter type `G`)   |
| `MAX_DAILY_EXPORTED_ACTIVE_POWER_T1`      | `25` | enable display of maximum daily negative active power `P-` for tariff `T1`, OBIS: `2.26.1` (for meter type `G` only)                                      |
| `MAX_DAILY_EXPORTED_ACTIVE_POWER_T2`      | `26` | enable display of maximum daily negative active power `P-` for tariff `T2`, OBIS: `2.26.2` (for meter type `G` only)                                      |
| `MAX_DAILY_EXPORTED_ACTIVE_POWER_T3`      | `27` | enable display of maximum daily negative active power `P-` for tariff `T3`, OBIS: `2.26.3` (for meter type `G` only)                                      |
| `MAX_DAILY_EXPORTED_ACTIVE_POWER_T4`      | `28` | enable display of maximum daily negative active power `P-` for tariff `T4`, OBIS: `2.26.4` (for meter type `G` only)                                      |
| `MAX_MONTHLY_EXPORTED_ACTIVE_POWER_T1`    | `29` | enable display of maximum monthly negative active power `P-` for tariff `T1`, OBIS: `2.16.1` (for meter type `G` only)                                    |
| `MAX_MONTHLY_EXPORTED_ACTIVE_POWER_T2`    | `30` | enable display of maximum monthly negative active power `P-` for tariff `T2`, OBIS: `2.16.2` (for meter type `G` only)                                    |
| `MAX_MONTHLY_EXPORTED_ACTIVE_POWER_T3`    | `31` | enable display of maximum monthly negative active power `P-` for tariff `T3`, OBIS: `2.16.3` (for meter type `G` only)                                    |
...
| Name                                                  | Bit  | Description                                                                                                             |
| ----------------------------------------------------- | ---- | ----------------------------------------------------------------------------------------------------------------------- |
| `MAXIMUM_MONTHLY_EXPORTED_ACTIVE_POWER_T4`            | `0`  | enable display of maximum monthly negative active power `P-` for tariff `T4`, OBIS: `2.16.4`, (for meter type `G` only) |
| `MAXIMUM_DAILY_EXPORTED_REACTIVE_POWER_T1`            | `1`  | enable display of maximum daily reactive power for tariff `T1`, `Q2`, OBIS: `6.26.1` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_REACTIVE_POWER_T2`            | `2`  | enable display of maximum daily reactive power for tariff `T2`, `Q2`, OBIS: `6.26.2` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_REACTIVE_POWER_T3`            | `3`  | enable display of maximum daily reactive power for tariff `T3`, `Q2`, OBIS: `6.26.3` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_REACTIVE_POWER_T4`            | `4`  | enable display of maximum daily reactive power for tariff `T4`, `Q2`, OBIS: `6.26.4` (for meter type `G` only)          |
| `MAXIMUM_MONTHLY_EXPORTED_REACTIVE_POWER_T1`          | `5`  | enable display of maximum monthly reactive power for tariff `T1`, `Q2`, OBIS: `6.16.1` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_REACTIVE_POWER_T2`          | `6`  | enable display of maximum monthly reactive power for tariff `T2`, `Q2`, OBIS: `6.16.2` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_REACTIVE_POWER_T3`          | `7`  | enable display of maximum monthly reactive power for tariff `T3`, `Q2`, OBIS: `6.16.3` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_REACTIVE_POWER_T4`          | `8`  | enable display of maximum monthly reactive power for tariff `T4`, `Q2`, OBIS: `6.16.4` (for meter type `G` only)        |
| `MAXIMUM_DAILY_EXPORTED_NEGATIVE_REACTIVE_POWER_T1`   | `9`  | enable display of maximum daily reactive power for tariff `T1`, `Q3`, OBIS: `7.26.1` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_NEGATIVE_REACTIVE_POWER_T2`   | `10` | enable display of maximum daily reactive power for tariff `T2`, `Q3`, OBIS: `7.26.2` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_NEGATIVE_REACTIVE_POWER_T3`   | `11` | enable display of maximum daily reactive power for tariff `T3`, `Q3`, OBIS: `7.26.3` (for meter type `G` only)          |
| `MAXIMUM_DAILY_EXPORTED_NEGATIVE_REACTIVE_POWER_T4`   | `12` | enable display of maximum daily reactive power for tariff `T4`, `Q3`, OBIS: `7.26.4` (for meter type `G` only)          |
| `MAXIMUM_MONTHLY_EXPORTED_NEGATIVE_REACTIVE_POWER_T1` | `13` | enable display of maximum monthly reactive power for tariff `T1`, `Q3`, OBIS: `7.16.1` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_NEGATIVE_REACTIVE_POWER_T2` | `14` | enable display of maximum monthly reactive power for tariff `T2`, `Q3`, OBIS: `7.16.2` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_NEGATIVE_REACTIVE_POWER_T3` | `15` | enable display of maximum monthly reactive power for tariff `T3`, `Q3`, OBIS: `7.16.3` (for meter type `G` only)        |
| `MAXIMUM_MONTHLY_EXPORTED_NEGATIVE_REACTIVE_POWER_T4` | `16` | enable display of maximum monthly reactive power for tariff `T4`, `Q3`, OBIS: `7.16.4` (for meter type `G` only)        |
...
| `ACCUMULATE_BY_R_PLUS_MINUS` | `7` | reactive energy accumulation type. `false` - reactive energy accumulation by quadrants `Q1`, `Q2`, `Q3`, `Q4`; `true` - reactive energy accumulation by `R+`, `R-` |
