...
| `0x39` | `WD_RESTART`                        | `C.057`           | Watchdog restart.                                                                       |
...
| `0x8B` | `OP_PARAMETERS_VALUES_FAULT`        | `C.139`           | Operator parameters lost.                                                               |
| `0x8C` | `OP_PARAMETERS_EXT_VALUES_FAULT`    | `C.140`           | Additional operator parameters lost.                                                    |
...
| `0x9E` | `CHANGE_PARAMETERS_CHANNEL1`        | `C.157`           | Load profile parameter `1` changed (since firmware version >= `302.17.001`).            |
| `0x9F` | `CHANGE_PARAMETERS_CHANNEL2`        | `C.158`           | Load profile parameter `2` changed.                                                     |
| `0xA0` | `CHANGE_PARAMETERS_CHANNEL3`        | `C.159`           | Load profile parameter `3` changed.                                                     |
| `0xA1` | `CHANGE_PARAMETERS_CHANNEL4`        | `C.160`           | Load profile parameter `4` changed.                                                     |
| `0xA2` | `CHANGE_PARAMETERS_CHANNEL5`        | `C.161`           | Load profile parameter `5` changed.                                                     |
| `0xA3` | `CHANGE_PARAMETERS_CHANNEL6`        | `C.162`           | Load profile parameter `6` changed.                                                     |
